package com.clickaway.constant;

import java.math.BigDecimal;

public class Constant {
    public static final String TITLE = "Welcome to OneClickAway Inc. Let's fill the shopping cart up!";
    public static final Long shoppingCartID = 1L;
